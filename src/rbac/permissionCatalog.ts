...
export const PERMISSION_CATALOG: PermissionCatalogEntry[] = [
  ...
  { name: 'view_counterparty_card', displayName: 'Просмотр карточки контрагента', description: 'Разрешает открывать общую карточку контрагента.', groupKey: 'service_client_orders' },
  { name: 'view_counterparty_finance', displayName: 'Финансы контрагента', description: 'Разрешает просматривать взаиморасчёты и задолженность контрагента.', groupKey: 'service_client_orders' },
  { name: 'view_counterparty_sales', displayName: 'Продажи контрагента', description: 'Разрешает просматривать продажи и заказы контрагента.', groupKey: 'service_client_orders' },
  { name: 'view_counterparty_contacts', displayName: 'Контакты контрагента', description: 'Разрешает просматривать контактные данные контрагента.', groupKey: 'service_client_orders' },
  { name: 'create_client_order_from_counterparty', displayName: 'Заказ из карточки контрагента', description: 'Разрешает создавать заказ из карточки контрагента.', groupKey: 'service_client_orders' },
