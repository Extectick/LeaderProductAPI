...
exports.toStringData = toStringData;
exports.normalizeAndValidate = normalizeAndValidate;
exports.assertQrType = assertQrType;
...
const ALLOWED_QR_TYPES = ['PHONE', 'LINK', 'EMAIL', 'TEXT', 'WHATSAPP', 'TELEGRAM', 'CONTACT'];
function toStringData(raw) {
...
function normalizeAndValidate(qrType, qrDataRaw) {
    ...
    const validationError = (0, validateQRData_1.validateQRData)(qrType, data);
    if (validationError)
        throw new Error(validationError);
    return data;
}
function assertQrType(type) {
    if (!type || !ALLOWED_QR_TYPES.includes(type)) {
